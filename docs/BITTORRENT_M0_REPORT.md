...
local DHT probe, rejects matching IPv6 traffic, proves a public lookup reached
the probe, and scans the captured packets for the private binary and text hash.
